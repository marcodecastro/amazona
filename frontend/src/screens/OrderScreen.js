...
initMercadoPago('APP_USR-b1281652-a506-4fdc-b894-b73608bc2d09');
        ...
        <Col md={8}>
          ...
          <Card className="mb-3">
            <Card.Body>
              ...
              <Card.Text>
                <strong>Metódo:</strong> {order.paymentMethod}
              </Card.Text>
              {order.isPaid ? (
                <MessageBox variant="success">
                  ...
                  <ListGroup.Item>
                    {isPending ? (
                      ...
                      <div>
                        ...
                        <Wallet
                           initialization={{
                          preferenceId: '615459548-e15e29ee-0f7f-482f-89c6-94a8469dc55a'
                             }} />
